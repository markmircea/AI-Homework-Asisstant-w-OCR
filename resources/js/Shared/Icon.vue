<template>
  ...
  <svg v-else-if="name === 'checkmark'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="w-6 h-6 fill-green-500">    <path d="M6 10l2 2 6-6-1.414-1.414L8 9.172l-2.586-2.586L4 6z"/></svg>
