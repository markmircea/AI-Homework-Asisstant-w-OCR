        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gradient-to-r from-indigo-400 to-indigo-600 text-white">
              <tr>
                <th scope="col"
                  class="w-1/8 px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Title</th>
                <th scope="col"
                  class="w-1/4 px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Question
                </th>
                <th scope="col"
                  class="w-7/12 px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Answer</th>
            ...
            <tbody class=" divide-y divide-gray-200">
              ...
              <tr v-for="announcement in announcements.data" :key="announcement.id" class="hover:bg-gray-50">
                <td class="w-1/8 px-6 py-4 whitespace-nowrap">
                  <Link class="flex items-center text-sm font-medium text-gray-900 hover:text-indigo-600"
                    :href="`/history-list/${announcement.id}/edit`">
                ...
                <td class="w-1/4 px-6 py-4">
                  <div class="text-sm text-gray-900 truncate-lines truncate-lines-2">{{ announcement.aiquery }} {{
                    announcement.extracted_text }}</div>
                </td>
...
.truncate-lines {
  ...
  -webkit-line-clamp: 3;
  /* Reduced to 2 lines for a more compact look */
  line-clamp: 3;
}
</style>
