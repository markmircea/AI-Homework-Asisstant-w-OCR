        ...
        <div class="lg:py-6 lg:pr-16">
          ...
          <div class="flex">
            ...
            <div class="pt-1 pb-8">
              ...
              <p class="text-gray-700">
                ...
                tropic island nest. Michael Knight a young loner.
              </p>
            </div>
          </div>
          <div class="flex">
            ...
            <div class="pt-1 pb-8">
              ...
              <p class="text-gray-700">
                Tell them I hate them. Is the Space Pope reptilian!? Tell her she looks thin. Hello, little man. I will
                destroy you!
              </p>
            </div>
          </div>
          <div class="flex">
            ...
            <div class="pt-1 pb-8">
              ...
              <p class="text-gray-700">
                If one examines precultural libertarianism, one is faced with a choice: either accept rationalism or
                conclude that context is a product.
              </p>
            </div>
          </div>
          <div class="flex">
