        ...
        <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Granualar Historic Searches</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
              Our advanced search option allows users to search through their old  searches, titles, qestions, answers and extracted image text.
            </dd>
          </div>
          ...
          <div class="relative">
            <dt>
              ...
              <p class="ml-16 text-lg leading-6 font-medium text-gray-900">We never share you data, FULL ENCRYPTION</p>
            </dt>
            <dd class="mt-2 ml-16 text-base text-gray-500">
No search that is done through easy ace will ever be used to train an AI model. We culdent access your data even if we wanted to as our databased uses RSA and Blowfish.            </dd>
          </div>
